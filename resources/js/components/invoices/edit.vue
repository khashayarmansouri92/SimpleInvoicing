...
const removeItem = (id, i) => {
    form.value.invoice.items.splice(i, 1)
    if (id !== undefined) {
...
const onEdit = (id) => {
    if (form.value.invoice_items.length >= 1) {
        ...
        formData.append('invoice_item', JSON.stringify(form.value.invoice_items.value))
            ...
            <div class="card__content">
                ...
                <div class="table">
                    ...
                    <div class="table--items2" v-for="(itemcard, i) in form.invoice_items" :key="itemcard.id">
                        ...
                        <p v-else>
                            #{{ itemcard.item_code }} {{ itemcard.description }}
                        </p>
                        <p>
                        ...
                        <p v-else></p>
                        <p style="color: red; font-size: 24px;cursor: pointer;" @click="removeItem(itemcard.id ,i)">
                            &times;
                        </p>
                    </div>
